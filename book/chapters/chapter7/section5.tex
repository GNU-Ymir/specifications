...
as detailed in Section~\ref{sec:class_override_for_loop}.
...
Listing~\ref{lst:flow:copy_value_iter_tu} and the loop at line 5 into the one shown
in Listing~\ref{lst:flow:ref_value_iter_tu}.
...
Listing~\ref{lst:flow:useless_mut_iterator}), and therefore can be modified. After
