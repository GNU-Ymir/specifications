...
\begin{lstlisting}[style=coloredverbatim, caption=Simple do while loop, label=lst:(chap7):simple_do_while_loop]
let mut count = 0;
...
\begin{lstlisting}[style=coloredverbatim, caption=While-let rewritten using loop and if-let, label=lst:(chap7):while_let_rewritten]
fn foo(i: i32)-> i32?;
