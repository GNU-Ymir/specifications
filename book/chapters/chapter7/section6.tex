...
\begin{lstlisting}[style=coloredverbatim, caption=Using two loops, label=lst:(chap7):compr_two_loops]
let dmut a = dcopy [[1, 2], [3, 4]];
...
\begin{lstlisting}[style=lyilVerb, label=lst:(chap7):list_compr_tuple_create_yil, caption=YIL representation of Listing~\ref{lst:(chap7):list_compr_tuple_create}]
a(#1) = [1, 2, 3];
YI(#3) = (len-> 3, ptr-> &a(#2));
#_value(#4) = YI(#3);
#_iter(#5) = 0;
