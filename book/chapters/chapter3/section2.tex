  ...
  \begin{adjustbox}{max width=1.01\linewidth}
    \begin{threeparttable}
      \begin{tabular}{|l|ll|}
        ...
        \texttt{min} & The smallest positive normalized & \texttt{typeof(x)}\\
        ...
        & to the value 1 &\\[0pt]
        \Xhline{0.001pt}
        \texttt{dig} & The number of decimal digits of precision & \texttt{u32}\\[0pt]
        \Xhline{0.001pt}
  ...
  \begin{center}
    \begin{adjustbox}{max width=1.0\linewidth}
      \begin{tabular}{|c|lll|}
        ...
        \texttt{-} & Subtraction & No & \texttt{1.0 - 8.0 == -7.0}\\[0pt]
        \texttt{*} & Multiplication & Yes & \texttt{3.0 * 4.0 == 12.0}\\[0pt]
        \texttt{/} & Division & No & \texttt{7.0 / 3.0 <=> 2.333}\\[0pt]
        \texttt{\%} & Remainder of division & No & \texttt{7.23 \% 3.09 <=> 1.05}\\[0pt]
        \verb~^^~ & Exponent & No & \texttt{7.0} \verb~^^~ \texttt{3 == 343.0}\\[0pt]
        \hline
      \end{tabular}
    \end{adjustbox}
  \end{center}
  ...
  \begin{center}
    \begin{adjustbox}{max width=1.0\linewidth}
      \begin{tabular}{|c|lll|}
        ...
        \hline
        \hline
        \texttt{>} & Greater than & No & \texttt{(12.0 > 11.0) == true}\\[0pt]
        \texttt{<} & Lower than & No & \texttt{(12.0 < 11.0) == false}\\[0pt]
        \texttt{>=} & Greater or equal & No & \texttt{(14.0 >= 14.0) == true}\\[0pt]
        \texttt{<=} & Lower or equal & No & \texttt{(11.0 <= 19.0) == true}\\[0pt]
        \texttt{==} & Equal & Yes & \texttt{(10.0 == 10.0) == true}\\[0pt]
        \texttt{!=} & Not equal & Yes & \texttt{(10.0 != 10.0) == false}\\[0pt]
        \texttt{<=>} & Is congruent & Yes & \texttt{(10.0 <=> 10.0) == true}\\[0pt]
        \texttt{<!>} & Is not congruent & Yes & \texttt{(10.0 <!> 10.0) == false}\\[0pt]
        \hline
      \end{tabular}
    \end{adjustbox}
  \end{center}
  ...
  \begin{center}
    \begin{adjustbox}{max width=1.0\linewidth}
      \begin{tabular}{|l|lll|}
        ...
        \hline
        \hline
        \texttt{..} & Range operator not inclusive & \texttt{34.0f .. 12.0f} & \texttt{[34.0f;12.0f[}\\[0pt]
            \texttt{...} & Range operator inclusive & \texttt{5.0f ... 89.0f} & \texttt{[5.0f;89.0f]}\\[0pt]
            \hline
      \end{tabular}
    \end{adjustbox}
  \end{center}
