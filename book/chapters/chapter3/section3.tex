...
%% \tokennolst sets its argument in \ttfamily with no listings `literate'
%% mapping, and the mono font has no Greek: use math-mode pi instead.
\item Using the direct representation of the character (e.g. \tokennolst{\ensuremath{\pi}}),
