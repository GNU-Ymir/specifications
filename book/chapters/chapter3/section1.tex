...
\begin{center}
  \begin{threeparttable}
    \begin{tabular}{|l|ll|}
      ...
      \hline
      \texttt{!} & Bitwise Not\(^{1}\) & \texttt{!19 == -20}\\[0pt]
      \hline
    \end{tabular}
    \begin{tablenotes}
  ...
  \begin{center}
    \begin{adjustbox}{max width=1.0\linewidth}
      \begin{tabular}{|c|lll|}
        ...
        \texttt{\%} & Remainder of the division & No & \texttt{13 \% 3 == 1}\\[0pt]
        \verb~^^~ & Exponent & No & \texttt{3} \verb~^^~ \texttt{4 == 81}\\[0pt]
        \hline
      \end{tabular}
    \end{adjustbox}
  \end{center}
  ...
  \begin{center}
    \begin{adjustbox}{max width=1.0\linewidth}
      \begin{tabular}{|c|l l l|}
        ...
        \hline
        \hline
        \texttt{\(\vert\)} & Bitwise Or & Yes & \texttt{0b001} \(\vert{}\) \texttt{0b010 == 0b011}\\[0pt]
        \texttt{\&} & Bitwise And & Yes & \texttt{0b001 \& 0b010 == 0b000}\\[0pt]
        \texttt{\textasciicircum{}} & Bitwise Xor & Yes & \texttt{0b001 \textasciicircum{} 0b011 == 0b010}\\[0pt]
        \Verb~>>~ & Bitwise right shift & No & \texttt{0b100000} \verb~>>~ \texttt{0b010 == 0b001000}\\[0pt]
        \Verb~<<~ & Bitwise left shift & No & \texttt{0b001000} \verb~<<~ \texttt{0b010 == 0b100000}\\[0pt]
        \hline
      \end{tabular}
    \end{adjustbox}
  \end{center}
