...
\label{sec:memory:pattern_vdecl}
...
conditional branching (cf. Section~\ref{sec:flow:if_else}) as they may or may not
...
As for any variable declaration the keyword \token{ref} creates a
...
so the keyword \token{ref} decorates the associated value to allow
