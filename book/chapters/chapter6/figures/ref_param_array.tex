\begin{minipage}{0.49\linewidth}
  \begin{figure}[H]
    ...
    \caption{\label{fig:memory:example_call_ref_array} Passing an array by reference}
  \end{figure}
\end{minipage}%
\begin{minipage}{0.49\linewidth}
  \begin{figure}[H]
    ...
    \end{adjustbox}
    \captionsetup{width=0.8\linewidth}
    \caption{\label{fig:memory:example_call_copy_array} Passing an array by value}
  \end{figure}
