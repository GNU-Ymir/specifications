...
\item Comparison operators are used to compare values,
...
\item Bitwise operators perform operations on values at the binary level. These
...
An example of arithmetic and comparison operators is presented in the following
