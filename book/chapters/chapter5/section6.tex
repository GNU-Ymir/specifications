...
alongside the package, as presented in Section~\ref{sec:function_body}.
...
\item \token{lazy} declares a global variable following the lazy protocol
  described in Section~\ref{sec:global_variables}. As any lazy variable, it
...
\mycautionbox { Nothing checks that the type written in an external declaration
