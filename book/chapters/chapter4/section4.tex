...
\begin{center}\begin{adjustbox}{max width=\linewidth}
  \begin{tabular}{|l|ll|}
    ...
    & with \texttt{contains} set to \texttt{false} where \texttt{T} is & \\
  ...
  \begin{center}\begin{adjustbox}{max width=\linewidth}
    \begin{threeparttable}
      \begin{tabular}{|l|ll|}
        ...
        \texttt {contains} & The field describing whether or not & \texttt{bool} \\
        & the \texttt{scd} value is contained in the range &\\
        \hline
      \end{tabular}
      \begin{tablenotes}
