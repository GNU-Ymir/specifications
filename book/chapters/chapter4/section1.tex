...
\item \textit{rvalue} -- An rvalue is the right operand involved in a
  ...
  Chapter~\ref{chap:variables}, the implicit cases in
  Section~\ref{sec:memory_movement} and mutability itself in
  Section~\ref{sec:variable_mutability}. Implicit means that
