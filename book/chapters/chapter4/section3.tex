...
parent. For example, the mutability of the following tuple type \token{mut (mut
  i32, f32, dmut *c8)} is shown in Figure~\ref{fig:(chap4):tuple_mutability}.
...
\begin{center}
  \begin{adjustbox}{max width=\linewidth}
    \begin{tabular}{|l|ll|}
      ...
      \hline
      \hline
      \texttt{init} & The initial value of the tuple, & \texttt{typeof(x)} \\
      & where every inner field is set to \texttt{T::init} & \\
      \Xhline{0.001pt}
